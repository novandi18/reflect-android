...
import com.novandiramadhan.reflect.presentation.viewmodel.SignInViewModel
...
fun SignInScreen(
    ...
    Column(
        ...
        RButton(
            ...
            enabled = email.isNotEmpty() && password.isNotEmpty() && uiState !is SignInUiState.Loading,
        ...
        GoogleSignInButton(
            onClick = viewModel::getTokenGoogleAuth,
